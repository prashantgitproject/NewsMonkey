...
export default class News extends Component {
  ...
  async updateNews() {
    ...
    &apiKey=0154721cb533489ca2decf04f74e699d&page=${this.props.page}&pageSize=${this.props.pageSize}`;
      ...
      <div className="container my-3">
        ...
        <div className="container d-flex justify-content-between">
          <button disabled={this.state.page <= 1}
            type="button" className="btn btn-dark" onClick={this.handlePrevClick}>&larr; Previous
            </button>
          <button disabled={this.state.page + 1 >
